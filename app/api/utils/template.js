        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/batteries">
                            <i class="fas fa-battery-half" style="width: 20px;"></i>
                            <span>Battery Informations<br></span>
                        </a>
                        <a class="nav-link" href="/inventory">
                            <i class="fas fa-clipboard-check" style="width: 20px;margin-right: 0px;margin-left: 3px;">
                            </i><span>Inventory<br></span></a>
                    </li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            ...
            <div id="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col" style="max-width: 250px;">
                            <form method="POST" id="tableForm" action="/getBattery">
                                <select name="_id" class="form-select-lg align-items-xxl-center"
                                    style="font-size: 17px;border-color: rgb(247,247,247);max-width: 100%;">
                                    <% for(var i=0; i < batteries.length; i++) { %>
                                        <option value="<%= batteries[i]._id %>" selected="">
                                            <%= batteries[i].name %>
                                                <%= batteries[i].brand %>
                                                    <%= batteries[i].cells %>
                                                        <%= batteries[i].capacity %> mah
                                        </option>
                                        <% } %>
                                </select>
                                <button type="submit" class="btn btn-primary" type="button"
                                    style="margin-left: 5px; position: absolute; float: left;"><i
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-auto" style="padding-top: 3px;width: 220px;">
                            <form method="GET" action="/edit/${data._id}"
                                enctype="application/x-www-form-urlencoded">
                                <button type="submit" class="btn btn-primary" type="button" style="width: 200px;"><i
                                        class="fa fa-edit" style="margin-right: 8px;"></i>Edit</button>
                            </form>
                        </div>
                        <div class="col-auto" style="padding-top: 3px;width: 220px;">
                            <form method="POST" action="/updateBattery/${data._id}"
                                enctype="application/x-www-form-urlencoded">
                                <input name="status" value="Charged" hidden aria-hidden="true">
                                <button type="submit" class="btn btn-primary" type="button"
                                    style="background: var(--bs-green);border-color: var(--bs-green);margin-right: -1px;width: 200px;"><svg
                        ...
                        <div class="col-auto" style="padding-top: 3px;width: 220px;">
                            <form method="POST" action="/updateBattery/${data._id}"
                                enctype="application/x-www-form-urlencoded">
                                <input name="status" value="Used" hidden aria-hidden="true">
                                <button type="submit" class="btn btn-primary" type="button"
                                    style="background: var(--bs-orange);border-color: var(--bs-orange);width: 200px;"><i
                                        class="fas fa-rocket" style="margin-right: 8px;"></i>Used</button>
                            </form>
                        </div>
                        <div class="col-auto" style="padding-top: 3px;width: 220px;">
                            <form method="POST" action="/updateBattery/${data._id}"
                                enctype="application/x-www-form-urlencoded">
                                <input name="status" value="Storage" hidden aria-hidden="true">
                                <button type="submit" class="btn btn-primary" type="button"
                                    style="background: var(--bs-yellow);border-color: var(--bs-yellow);width: 200px;"><svg
                        ...
                        <div class="col-auto" style="padding-top: 3px;width: 220px;">
                            <form method="POST" action="/updateBattery/${data._id}"
                            <input name="status" value="Out of service" hidden aria-hidden="true">
                                enctype="application/x-www-form-urlencoded">
                                <button type="submit" class="btn btn-primary" type="button"
                                    style="background: var(--bs-red);border-color: var(--bs-red);width: 200px;"><i
                                        class="fas fa-dumpster-fire" style="margin-right: 8px;"></i>Out of
                                    service</button>
                            </form>
                        </div>
                            ...
                            <div class="col" style="min-width: 300px; margin-left: 10px;">
                                ...
                                <div class="row">
                                    <div class="col" style="min-width: 300px">
                                        <h6><strong>Brand :</strong>
                                            <%= battery.brand %><br><strong>Cells :</strong>
                                                <%= battery.cells %><br><strong>Capacity :</strong>
                                                    <%= battery.capacity %> mah (<%= battery.efficiency %> C)<br><br>
                                        </h6>
                                    </div>
                                    <div class="col" style="min-width: 300px">
                                        <h6><strong>Buy date :</strong>
                                            <%= battery.buyDate.toISOString().substring(0, 10) %><br><strong>Last Usage :</strong>
                                                <%= battery.lastUsageDate ? battery.lastUsageDate.toISOString().substring(0, 10) : '' %><br><strong>State :</strong>
                                                ...
                                                <div class="row align-items-center no-gutters">
                                                    <div class="col me-2">
                                                        <div class="text-uppercase text-primary fw-bold text-xs mb-1">
                                                            <span
                                                                class="text-success"><strong>Cycles</strong><br></span>
                                                        </div>
                                                    ...
                                                    <div class="col-auto"><i
                                                            class="fa fa-refresh fa-2x text-success"></i></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row" style="margin-top: 18px;">
                            ...
                            <div class="col-lg-5 col-xl-4">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body" style="height: 397px;">
                                        <div class="chart-area" style="height: 370px;"><canvas
                                                data-bss-chart="{&quot;type&quot;:&quot;line&quot;,&quot;data&quot;:{&quot;labels&quot;:[&quot;&quot;],&quot;datasets&quot;:[{&quot;label&quot;:&quot;&quot;,&quot;fill&quot;:true,&quot;data&quot;:[&quot;3&quot;,&quot;2.8&quot;,&quot;2.8&quot;,&quot;2.6&quot;,&quot;2.6&quot;,&quot;2.2&quot;],&quot;borderColor&quot;:&quot;#ffffff&quot;,&quot;borderWidth&quot;:&quot;0&quot;,&quot;backgroundColor&quot;:&quot;rgba(239,91,91,0.64)&quot;}]},&quot;options&quot;:{&quot;maintainAspectRatio&quot;:false,&quot;legend&quot;:{&quot;display&quot;:false,&quot;position&quot;:&quot;top&quot;},&quot;title&quot;:{},&quot;scales&quot;:{&quot;xAxes&quot;:[{&quot;gridLines&quot;:{&quot;drawBorder&quot;:true,&quot;drawTicks&quot;:true}}],&quot;yAxes&quot;:[{&quot;gridLines&quot;:{&quot;drawBorder&quot;:true,&quot;drawTicks&quot;:true,&quot;drawOnChartArea&quot;:true}}]}}}"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card shadow">
                                    <h3 class="text-dark mb-4"
                                        style="margin-top: 24px;margin-right: 0px;margin-left: 11px;">Last events</h3>
                ...
                <footer class="bg-white sticky-footer" style="height: 25px;">
                    <div class="container my-auto">
                        <div class="text-center my-auto copyright"><span>Made by Mickael "PAPAMICA" Asseline</span>
                        </div>
                    </div>
                </footer>
